...
public class NAFFD {
    ...
    private int thresholdROIFactor;
    private int cntr;
...
//	private long  p_thresholdROIFactor;
    ...
    public NAFFD(int height, int width, int imageChannels, int resizedFactor, double thresholdEntireImage, int thresholdROIFactor,int cntrResetValue) {
        this.height = height;
        this.width = width;
